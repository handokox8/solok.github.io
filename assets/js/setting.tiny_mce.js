...
tinyMCE.init({
    ...
    width : '100%',
    convert_urls : false, 
    plugins : 'bestandsbeheer,tabfocus,advimage,advimagescale,loremipsum,image_tools,embed,tableextras,style,table,inlinepopups,searchreplace,contextmenu,paste,wordcount,advlist,autosave',
...
/*
    ...
    theme_advanced_buttons2 : "formatselect, forecolor,pastetext,pasteword,anchor,image,code",
