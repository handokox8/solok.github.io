										...
										foreach ($news_all as $news) {
											...
											<tr>
												...
												<td width="20%"><?php echo $news->title; ?><br />
													<span><a href="<?php echo base_url('news/edit_news/'.$news->idNews.'/'.$url); ?>" title="ubah Konten">Edit</a> | <a href="<?php echo base_url('news/del_news/'.$news->idNews.'/'.$url); ?>" onclick="return confirm('setuju dihapus?')" style="color: #ff0000">Hapus Permanen</a> | <a href="<?php echo base_url('news/index/'.$news->idNews.'/'.$url); ?>" title="lihat hasil" target="_blank">Lihat</a></span>
												</td>
