							...
							<div class="twinner">
								...
								<div class="twin-container twin30 twin-akhir">
									<div class="twin">	
										...
										<div class="twin-isi">
											<div class="isis">
												<?php echo form_open_multipart(base_url('client/add_client')); ?>
													<table style="width: 100%">
														<tbody>
															<tr>
																<td class="bella">Nama Klien</td>
																<td class="isi"><?php echo form_input(array('name'=>'nama', 'class'=>'input-full', 'placeholder'=>'Nama klien')); ?></td>
															</tr>
															<tr>
																<td class="bella">Rincian</td>
																<td class="isi"><?php echo form_textarea(array('name'=>'detail', 'class'=>'textarea-full', 'placeholder'=>'Rincian klien')); ?></td>
															</tr>
															<tr>
