...
<ul id='sidemenu'>
    	<li id='tab-type'><a href='<?php echo site_url('uploads/index');?>' >From Computer</a></li>
...
<div id='media-upload-error-6' class='hidden'></div><div class='filename hidden'></div>
	<img class="pinkynail toggle" src="<?php echo base_url()?>assets/uploads/<?php echo $gallery->file;?>" alt="">
	...
	<table class="slidetoggle describe startclosed" style="display: none; " id="slidetoggle-<?php echo $gallery->id_attach;?>">
        ...
        <tr valign="top">
            ...
            <p><img class="thumbnail" width="100" id="file-<?php echo $gallery->id_attach; ?>" src="<?php echo base_url();?>/assets/uploads/<?php echo $gallery->file;?>" alt=""></p>
             </td>
            <td>
        ...
        <tr class="image-size">
            ...
            <td class="field"><div class="image-size-item"><input type="radio" name="image-size<?php echo $gallery->id_attach?>" class="image-size-<?php echo $gallery->id_attach?>" value="thumbnail"><label for="image-size-thumbnai">Thumbnail</label> <label for="image-size-thumbnail" class="help">(150&nbsp;x&nbsp;150)</label></div>
            <div class="image-size-item"><input name="image-size<?php echo $gallery->id_attach?>" type="radio"  class="image-size-<?php echo $gallery->id_attach?>" value="medium" checked="checked"><label for="image-size-medium">Medium</label> <label for="image-size-medium" class="help">(300&nbsp;x&nbsp;168)</label></div>
            <div class="image-size-item"><input name="image-size<?php echo $gallery->id_attach?>" type="radio"  class="image-size-<?php echo $gallery->id_attach?>" value="large"><label for="image-size-large">Large</label> <label for="image-size-large" class="help">(584&nbsp;x&nbsp;327)</label></div>
            <div class="image-size-item"><input name="image-size<?php echo $gallery->id_attach?>" type="radio"  class="image-size-<?php echo $gallery->id_attach?>" value="full"><label for="image-size-full">Full Size</label> <label for="image-size-full" class="help">(1366&nbsp;x&nbsp;768)</label></div></td>
        </tr>
        <tr class="submit"><td></td><td class="savesend">
            <button class="insert-image btn btn-grey" data="<?php echo $gallery->id_attach?>" class="button" >Insert into Post</button> 
