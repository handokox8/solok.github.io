	...
	<body OnLoad="document.<?php echo $form_load; ?>.username.focus();">
		<div id="form-login">
			...
			<div id="isi">
				...
				<div class="error">
					<p><i class="icon-exclamation-sign icon-large"></i>
				...
				<?php echo form_open(base_url('ngadmin/login'),array('name'=>'myform')); ?>
				...
				<div style="font-size: 12px;">
					<a href="<?php echo base_url('ngadmin/lupa'); ?>" style="color: #005E8A;">Lupa kata kunci?</a> | <a href="<?php echo base_url(); ?>" style="color: #005E8A;">Kembali Ke-halaman situs</a>
				</div>
			</div>
		</div>
		<div id="copy">
