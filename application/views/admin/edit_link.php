							...
							<div class="twinner">
								<div class="twin-container twin30 twin-awal">
									<div class="twin">	
										...
										<div class="twin-isi">
											<div class="isis">
												<?php echo form_open(base_url('setting/edit_link')); ?>
												<?php echo form_hidden('kdLink', $link_id->idLink); ?>
												<table style="width: 100%">
													<tbody>
														<tr>
															<td class="bella">Judul Link</td>
															<td class="isi"><?php echo form_input(array('name'=>'title', 'class'=>'input-full', 'placeholder'=>'judul link', 'value'=>$link_id->title)); ?></td>
														</tr>
														<tr>
															<td class="bella">Link URL</td>
															<td class="isi"><?php echo form_input(array('name'=>'link', 'class'=>'input-full', 'placeholder'=>'link URL', 'value'=>$link_id->url)); ?></td>
														</tr>
														<tr>
