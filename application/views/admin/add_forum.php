									...
									<div class="twin">	
										...
										<div class="twin-isi">
											<div class="isis">
												...
												<?php echo form_open_multipart(base_url('forum/add_forum'), array('id'=>'formPages')); //news/add_news ?>
										...
										<div class="twin-isi">
											<div class="isis">
												<table style="width: 100%">
													...
													<tr>
														<td class="isi"><?php echo form_input(array('name'=>'titleSeo', 'class'=>'input-full', 'placeholder'=>'judul SEO forum')); ?></td>
													</tr>
													<tr>
														<td><?php echo form_label('Deskripsi forum :', 'deskripsi'); ?></td>
													</tr>
													<tr>
														<td class="isi"><?php echo form_textarea(array('name'=>'deskripsi', 'class'=>'textarea-full', 'placeholder'=>'deskripsi forum')); ?></td>
													</tr>
													<tr>
														<td><?php echo form_label('Kata kunci forum :', 'keyword'); ?></td>
													</tr>
													<tr>
														<td class="isi"><?php echo form_input(array('name'=>'keyword', 'class'=>'input-full', 'placeholder'=>'kata kunci forum, pisahkan dengan tanda koma')); ?></td>
													</tr>
													<tr>
