									...
									<div class="twin">	
										...
										<div class="twin-isi">
											<div class="isis">
												...
												<?php echo form_open(base_url('admin_pages/add_pages'), array('id'=>'formPages')); ?>
										...
										<div class="twin-isi">
											<div class="isis">
												<table style="width: 100%">
													...
													<tr>
														<td class="isi"><?php echo form_textarea(array('name'=>'deskripsi', 'class'=>'textarea-full')); ?></td>
													</tr>
													<tr>
														<td><?php echo form_label('Keyword Pages :', 'keyword'); ?></td>
													</tr>
													<tr>
														<td class="isi"><?php echo form_input(array('name'=>'keyword', 'class'=>'input-full')); ?></td>
													</tr>
													<tr>
